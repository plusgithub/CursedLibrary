...
public final class InventoryCreator {
	 ...
	 */
	private InventoryCreator(int size, String title, String id) {
		this.size = size;
		this.title = title;
		this.id = id;
	...
	public void display(Player player) {
		...
		final Inventory inv = Bukkit.createInventory(player, size, Common.colorize("&0" + title + "                                                                                                                                                                                                                                                                                                                                                         ID:" + id));
	 ...
	 */
	public static InventoryCreator of(int size, String title) {
		return new InventoryCreator(size, title, "");
	}

	public static InventoryCreator of(int size, String title, String id) {
		return new InventoryCreator(size, title, id);
	}
}
