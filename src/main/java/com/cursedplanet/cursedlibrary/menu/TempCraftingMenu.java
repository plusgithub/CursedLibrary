...
public class TempCraftingMenu extends CursedMenu {
	...
	public TempCraftingMenu() {
		...
		lockFilled(fillEmpty(new ItemStack(Material.GRAY_STAINED_GLASS_PANE), 10, 11, 12, 19, 20, 21, 28, 29, 30, 24));
		...
		addClickUpdate(() -> {
			Common.runLater(1, () -> {
				if (getItemAt(10) != null && getItemAt(11) != null && getItemAt(12) != null) {
					addClickable(24, new ItemStack(Material.DIAMOND_AXE), (e) -> {
						fillRectangle(new ItemStack(Material.AIR), 10, 12);
						Common.runLater(1, () -> {
