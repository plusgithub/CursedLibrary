...
public abstract class SimpleLocalization extends YamlStaticConfig {
	...
	public static final class Commands {
		...
		/**
		 * Key for when plugin is reloading {@link com.cursedplanet.cursedlibrary.lib.plugin.SimplePlugin}
		 */
		public static String RELOADING = "reloading";

		/**
		 * Key for when plugin is disabled {@link com.cursedplanet.cursedlibrary.lib.plugin.SimplePlugin}
		 */
